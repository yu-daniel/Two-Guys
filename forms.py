...
class IngredientsForm(FlaskForm):
    order_date = StringField('Order Date', validators=[DataRequired(), Length(min=1, max=10)], render_kw={"placeholder": "YYYY-MM-DD"})
...
class OrderForm(FlaskForm):
    date_time = StringField('Date', validators=[DataRequired(), NumberRange(min=1, max=10)], render_kw={"placeholder": "YYYY-MM-DD"})
